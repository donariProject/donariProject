      ...
      <div class="video" style="float: left; width: 800px" >
            <div class="vide-inner" style="margin-left: 100px">
               <div class="container">
                   ...
                   <source src="resources/output/outvid.mp4" type='video/mp4'  style="width: 685px" id="videoStatus" >
                  </video>
         ...
         <div class="podcast-meta-element" style="width: 300px; height: 75px" >
			...
			<div class="podcast-meta-element" style="width: 300px; height: 75px">
				...
				<a href="resources/output/outvid.mp4" download style="text-align: center;">
		<div class="podcast-meta-element" style="width: 300px; height: 75px">
