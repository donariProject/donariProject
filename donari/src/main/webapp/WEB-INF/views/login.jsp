...
<body itemscope itemtype="http://schema.org/WebSite">
	...
	<section id="about-us" class="section-negative">
		<div class="container">
			...
			<h2 class="title-default text-center">Login</h2>
				<table class="tablelocation">
					<tr>
						<td style="font-size: 16pt;">I D</td>
						<td><input type="text" id="id"></td>
					</tr>
					<tr>
						<td style="font-size: 16pt;">Password</td>
						<td><input type="password" id="password">
					</tr>
					<tr>
						<td colspan="2">
							<button id="loginButton" onclick="checkId()" style="font-size: 16pt;">Login</button>
							<button id="joinButton" onclick="joingo()" style="font-size: 16pt;">Join</button>  
						</td>
					</tr>
				</table>
			</div>
